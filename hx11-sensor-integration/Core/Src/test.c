...
//	    SensorData *data = (SensorData *)argument;
//
//	    /* removed duplicate HAL_ADC_Start_DMA call.
//	     * DMA was already started in init_sensors(). */
//
//	  /* Infinite loop */
//	  for(;;)
//	  {
...
//	  osMutexRelease(sensorMutex);
//
//	  /* Fill protocol fields that aren't from sensors */
//	  localCopy.start_marker = 0xAA;
//	  localCopy.pod_state = (uint8_t)fsm.currentState;
//	  strncpy(localCopy.message, "OK", sizeof(localCopy.message));
//
//	  HAL_StatusTypeDef res = HAL_UART_Transmit(&huart7, (uint8_t*)&localCopy, sizeof(SensorData), 100);
//
//	  if (res != HAL_OK) {
...
//	  if (newCommandFlag == 1) {
//		  newCommandFlag = 0;
//		  u_int8_t recievedCmd = rxBuffer[0];
...
//
//		// simulate commands every few seconds
//		if (now - lastTime > 3000) {
//			lastTime = now;
//			static int step = 0;
//			step++;
//			switch(step) {
////				case 1: pendingCmd = CMD_LOAD; break;
////				case 2: pendingCmd = CMD_PRECHARGE; break;
////				case 3: pendingCmd = CMD_STOP; break;
////				case 4: pendingCmd = CMD_INIT; step = 0; break;
//				case 1: pendingCmd = CMD_LOAD; break;
//			    case 2: pendingCmd = CMD_STOP; break;        // test LOAD → STOP
//			    case 3: pendingCmd = CMD_LOAD; break;
//			    case 4: pendingCmd = CMD_PRECHARGE; break;
//			    case 5: pendingCmd = CMD_STOP; break;
//			    case 6: pendingCmd = CMD_INIT; step = 0; break;
//			}
//			hasCommand = true;
//		}
//
//		printf("State: %s | Cmd: %d | hasCmd: %d\r\n",
//		       state_to_string(fsm.currentState),
//		       pendingCmd,
//		       hasCommand);
//
//
...
//		}
//
//	printf("TRANSITION: %s -> %s\r\n", state_to_string(fsm.previousState), state_to_string(fsm.currentState));
//    osDelay(50);
//  }
